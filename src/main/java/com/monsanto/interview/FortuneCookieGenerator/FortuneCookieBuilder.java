...
public class FortuneCookieBuilder {
    ...
    /** Declaração das váriaveis devem 
     * sem públicas para pode sofrer alteração 
     * de novos valores  */
    public String client = NOT_DEFINED;
    public String company = NOT_DEFINED;
    public String quote = NOT_DEFINED;
